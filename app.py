...
<span class="header-badge">AI-POWERED ASSESSMENT</span>
    ...
    st.markdown(
        '<div class="section-subtitle">Provide accurate applicant information for better predictions.</div>',
        unsafe_allow_html=True,
    )

    # ---- Personal & financial details ----
    st.markdown(
        glass_card_header("👤", "Personal & Financial Details", "Applicant demographic and financial information"),
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        glass_card_header("📋", "Loan Application Details", "Select information related to the loan application"),
        unsafe_allow_html=True,
    )
    ...
    # ---- Predict button ----
    st.markdown("<br>", unsafe_allow_html=True)
    predict_button = st.button("🔮  PREDICT LOAN REPAYMENT")

    if predict_button:
        st.markdown(
            """<div class="prediction-card">
<h2>🤖 Prediction Ready</h2>
<p>Applicant information has been successfully collected and is ready for the trained model.</p>
<div class="prediction-status">MODEL READY • GRADIENT BOOSTING</div>
</div>""",
            unsafe_allow_html=True,
        )

        st.success(
            "The UI is ready. Connect your saved Gradient Boosting model to generate the actual prediction."
        )
...
<p>LoanPredict AI is a machine learning-based system designed to predict whether a loan applicant is likely to repay their loan.</p>
<hr>
<h2>🤖 Machine Learning Model</h2>
<p><strong>Gradient Boosting Classifier</strong></p>
<p>The Gradient Boosting algorithm was selected based on its strong classification performance across the evaluated metrics.</p>
<hr>
...
<hr>
<h2>🛠 Technologies</h2>
<p>Python • Pandas • NumPy • Scikit-learn • Streamlit • Gradient Boosting</p>
</div>""",
        unsafe_allow_html=True,
    )
